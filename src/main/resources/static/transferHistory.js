...
//if (payeeName != null || payeeName != undefined) {
  alert("payeeName"+payeeName);
  alert("getfundTransferHistory calld" + cid);


  var request = new XMLHttpRequest();
  if (payeeName != null && payeeName != undefined && payeeName.length>0) {
    request.open('POST', 'http://localhost:8080/api/v1/getfundTransferHistoryByName', true);
  }
  else {
